...
def certificates(request):
    ...
    param={'name':'Aman','middlename':'Kumar','sirname':'Mishra','language':'Django','cert_background':certback1,'certback1':certback1,'certback2':certback2,'certback3':certback3,'gender':'his/her','gender1':'him/her','gender2':'Mr/Miss'}
    firstn=request.POST.get('fname','Aman')
    middlen=request.POST.get('mname','Kumar')
    lastn=request.POST.get('lname','Mishra')
